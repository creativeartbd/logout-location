...
<?php
	...
	public function wpll_settings_ajax() {
		...
		if( 'accesslist' === $button_for ) {
			...
			$get_accesslists = isset( $_POST['accesslist'] ) ? sanitize_text_field( $_POST['accesslist'] ) : ''; 
			$accesslist_escaped = [];
...
// Activation hook
register_activation_hook( __FILE__, [ 'Logout_Location', 'activate' ] );
